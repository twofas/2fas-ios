...
protocol UploadLogsSuccessFlowControlling: AnyObject {
    func toClose()
}

final class UploadLogsSuccessFlowController: FlowController {
    private weak var parent: UploadLogsSuccessFlowControllerParent?
...
extension UploadLogsSuccessFlowController: UploadLogsSuccessFlowControlling {
    func toClose() {
        parent?.uploadLogsSuccessClose()
    }
}
