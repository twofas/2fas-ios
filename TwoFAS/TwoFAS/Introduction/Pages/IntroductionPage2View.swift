...
final class IntroductionPage2View: IntroductionPageView {
    private let image: UIImageView = {
        let img = UIImageView(image: Asset.introductionPage0.image)
    ...
    private func commonInit() {
        titleLabel.text = T.Introduction.page2Title
        contentLabel.text = T.Introduction.page2Content
