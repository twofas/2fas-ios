...
struct WebExtensionAwaitingAuth: Equatable {
    let tokenRequestID: String
    let domain: String
    let extensionID: ExtensionID
}

enum WebExtensionAwaitingAuthError: Error {
    case noInternet
    case serverError
    case notRegistered
}

enum WebExtensionAuthorizeError: Error {
    case noInternet
    case serverError
    case notRegistered
    case expired
...
protocol WebExtensionAuthInteracting: AnyObject {
