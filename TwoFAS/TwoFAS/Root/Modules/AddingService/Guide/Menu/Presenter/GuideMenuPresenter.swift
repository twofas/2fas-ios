...
final class GuideMenuPresenter: ObservableObject {
    ...
    private let flowController: GuideMenuFlowControlling
    private let guide: GuideDescription
    
    init(flowController: GuideMenuFlowControlling, guide: GuideDescription) {
