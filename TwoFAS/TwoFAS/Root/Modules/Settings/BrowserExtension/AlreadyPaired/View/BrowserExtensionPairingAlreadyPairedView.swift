...
struct BrowserExtensionPairingAlreadyPairedfulView: View {
...
struct BrowserExtensionPairingAlreadyPairedfulView_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            BrowserExtensionPairingAlreadyPairedfulView {}
