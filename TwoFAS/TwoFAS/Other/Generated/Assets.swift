...
internal enum Asset {
  ...
  internal static let settingsTouchIDDisabled = ImageAsset(name: "SettingsTouchIDDisabled")
  internal static let settingsTouchIDEnabled = ImageAsset(name: "SettingsTouchIDEnabled")
  ...
  internal static let tabBarIconNotificationsActive = ImageAsset(name: "TabBarIconNotificationsActive")
  internal static let tabBarIconNotificationsInactive = ImageAsset(name: "TabBarIconNotificationsInactive")
