...
public extension AppColor {
    var uiColor: UIColor {
        UIColor { trait in
            ...
            case .dark: UIColor(self.darkColor)
            case .unspecified, .light: UIColor(self.lightColor)
            @unknown default: UIColor(self.lightColor)
            }
        }
    }
}
...
private extension AppColor {
    var light: Color {
        ...
        // Accents
        case .accentsDefault: Color(.sRGB, red: 0.9216, green: 0.9216, blue: 0.9216, opacity: 1)
    ...
    var dark: Color {
        ...
        // Accents
        case .accentsDefault: Color(.sRGB, red: 0.1373, green: 0.1412, blue: 0.1569, opacity: 1)
