...
final class TrashViewTableViewCell: UITableViewCell {
    ...
    private let menuButton: UIButton = {
        ...
        let button = UIButton(frame: CGRect(origin: .zero, size: .init(width: buttonSize, height: buttonSize)))
        button.setImage(UIImage(systemName: "ellipsis"), for: .normal)
        button.imageView?.tintColor = Theme.Colors.Icon.normal
    ...
    private func menu() -> UIMenu {
        ...
        return UIMenu(title: T.Commons.service, children: [restore, delete])
    }
    
    func update(icon: UIImage, title: String, subtitle: String?, indexPath: IndexPath) {
