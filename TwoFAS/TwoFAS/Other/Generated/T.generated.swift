...
internal enum T {
  ...
  internal enum Backup {
    ...
    /// iCloud is encrypted using a shared key. Ensure that you have enabled the iCloud Keychain.
    internal static let cloudEncryptedSystem = T.tr("Localizable", "backup__cloud_encrypted_system", fallback: "iCloud is encrypted using a shared key. Ensure that you have enabled the iCloud Keychain.")
    /// iCloud is encrypted using custom password. Enter the password and enable sync.
    internal static let cloudEncryptedUser = T.tr("Localizable", "backup__cloud_encrypted_user", fallback: "iCloud is encrypted using custom password. Enter the password and enable sync.")
    /// Can't decrypt Cloud Backup because it's encrypted using System Key and you're using custom password. Would you like to switch?
    internal static let cloudErrorMismatchKeyContent = T.tr("Localizable", "backup__cloud_error_mismatch_key_content", fallback: "Can't decrypt Cloud Backup because it's encrypted using System Key and you're using custom password. Would you like to switch?")
    ...
    /// Can't sync with Cloud Backup because it was migrated by newer version of the app. Update the app to continue using Cloud Backup.
    internal static let cloudErrorNewVersionContent = T.tr("Localizable", "backup__cloud_error_new_version_content", fallback: "Can't sync with Cloud Backup because it was migrated by newer version of the app. Update the app to continue using Cloud Backup.")
    /// Cloud Backup error
    ...
    /// Change Encryption
    internal static let encryptionChangeTitle = T.tr("Localizable", "backup__encryption_change_title", fallback: "Change Encryption")
    /// Enter password
    ...
    internal static let encryptionMethodAction = T.tr("Localizable", "backup__encryption_method_action", fallback: "Change encryption method")
    /// Select System or User encryption
    internal static let encryptionMethodFooter = T.tr("Localizable", "backup__encryption_method_footer", fallback: "Select System or User encryption")
    /// Encryption method
    internal static let encryptionMethodTitle = T.tr("Localizable", "backup__encryption_method_title", fallback: "Encryption method")
    /// Password is used to encrypt your data. If you loose it you won't be able to recover data from Cloud Backup.
    internal static let encryptionPasswordDescription = T.tr("Localizable", "backup__encryption_password_description", fallback: "Password is used to encrypt your data. If you loose it you won't be able to recover data from Cloud Backup.")
    /// Select encryption
    internal static let encryptionSelect = T.tr("Localizable", "backup__encryption_select", fallback: "Select encryption")
    /// Encryption type
    ...
    /// iCloud Backup is encrypted by your password. Enter password to enable sync
    internal static let enterPasswordDescription = T.tr("Localizable", "backup__enter_password_description", fallback: "iCloud Backup is encrypted by your password. Enter password to enable sync")
    /// Type in password
    ...
    internal static let enterPasswordWrongPassword = T.tr("Localizable", "backup__enter_password_wrong_password", fallback: "Wrong password! Try again")
    ...
    /// Managed Apple Watches
    internal static let managePairedWatchesAction = T.tr("Localizable", "backup__manage_paired_watches_action", fallback: "Managed Apple Watches")
    ...
    /// Add, remove or rename Apple Watches which have access to this Cloud Backup.
    internal static let managePairedWatchesFooter = T.tr("Localizable", "backup__manage_paired_watches_footer", fallback: "Add, remove or rename Apple Watches which have access to this Cloud Backup.")
    /// Rename
    ...
    /// Managed paired Apple Watches
    internal static let managePairedWatchesTitle = T.tr("Localizable", "backup__manage_paired_watches_title", fallback: "Managed paired Apple Watches")
    /// Manage Watches
    ...
    /// Your backup is being encrypted using a generated key. This key will be shared amongst your app installations using iCloud Keychain so remember to have that option turned on. If you want to use your own key and password you can do that in Cloud Backup settings right after the migration.
    internal static let migrationDescription = T.tr("Localizable", "backup__migration_description", fallback: "Your backup is being encrypted using a generated key. This key will be shared amongst your app installations using iCloud Keychain so remember to have that option turned on. If you want to use your own key and password you can do that in Cloud Backup settings right after the migration.")
    /// Don't turn the app off!
    ...
    internal static let syncDisabled = T.tr("Localizable", "backup__sync_disabled", fallback: "Sync is currently disabled.")
    /// Sync is not available: %@
    internal static func syncNotAvailable(_ p1: Any) -> String {
      return T.tr("Localizable", "backup__sync_not_available", String(describing: p1), fallback: "Sync is not available: %@")
    }
    /// Syncing…
    ...
    /// Enter Backup section in 2FAS Settings on your iPhone/iPad and navigate to Manage Apple Watches. It will be visible if the state of Cloud Backup is Synced. Scan the QR code from there.
    internal static let watchPairDescription = T.tr("Localizable", "backup__watch_pair_description", fallback: "Enter Backup section in 2FAS Settings on your iPhone/iPad and navigate to Manage Apple Watches. It will be visible if the state of Cloud Backup is Synced. Scan the QR code from there.")
    ...
    /// Do you want to pair an Apple Watch with your Cloud Backup? Enter name for your device:
    internal static let watchPairingDescription = T.tr("Localizable", "backup__watch_pairing_description", fallback: "Do you want to pair an Apple Watch with your Cloud Backup? Enter name for your device:")
    /// Can't pair watch now. Make sure the Cloud Backup is enabled, synced and you're using a password.
    internal static let watchPairingError = T.tr("Localizable", "backup__watch_pairing_error", fallback: "Can't pair watch now. Make sure the Cloud Backup is enabled, synced and you're using a password.")
    /// Watch Pairing
    internal static let watchPairingTitle = T.tr("Localizable", "backup__watch_pairing_title", fallback: "Watch Pairing")
  }
