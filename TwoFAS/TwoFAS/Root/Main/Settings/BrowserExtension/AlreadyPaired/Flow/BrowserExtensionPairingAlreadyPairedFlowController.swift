...
protocol BrowserExtensionPairingAlreadyPairedFlowControlling: AnyObject {
    func toClose()
}
...
extension BrowserExtensionPairingAlreadyPairedFlowController: BrowserExtensionPairingAlreadyPairedFlowControlling {
    func toClose() {
        parent?.browserExtensionAlreadyPairedClose()
    }
}
