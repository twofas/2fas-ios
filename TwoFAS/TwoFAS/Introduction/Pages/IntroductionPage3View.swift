...
final class IntroductionPage3View: IntroductionPageView {
    private let image: UIImageView = {
        let img = UIImageView(image: Asset.introductionPage1.image)
    ...
    private func commonInit() {
        titleLabel.text = T.Introduction.page3Title
        contentLabel.text = T.Introduction.page3Content
